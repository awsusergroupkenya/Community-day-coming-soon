...
(function($) {
    ...
    function pageBackground() {
        ...
        if (body.hasClass('image-background')) { // Image background
            $.backstretch(["images/backgrounds/nairobi-center-panorama-kenya.jpg"]); // Replace here Image Background
        } else if (body.hasClass('slideshow-background')) { // Slideshow background
            $.backstretch([
                "images/backgrounds/nairobi-center-panorama-kenya.jpg", // Add different images
                "images/backgrounds/nairobi-center-panorama-kenya.jpg",
                "images/backgrounds/nairobi-center-panorama-kenya.jpg",
                "images/backgrounds/nairobi-center-panorama-kenya.jpg",
                "images/backgrounds/nairobi-center-panorama-kenya.jpg"
            ], {
            ...
            if (!$('html').hasClass('touch') && !body.hasClass('mobile')) { // Detect mobile devices
                ...
                $.backstretch(["images/backgrounds/nairobi-center-panorama-kenya.jpg"]);
            }
        }
    }
    pageBackground();
    ...
    if (clock.length) {
        if (clock.hasClass('js-timer-elapsed')) {
            ...
            // Default countdown
            clock.countdown('2024/04/13 12:00:00').on('update.countdown', function(event) {
                var output = [
